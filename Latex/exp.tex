...
\begin{table}[h!]
  ...
  \begin{center} 
    ...
    \hline
    \multirow{2}{*}{\textbf{Date}} & \multirow{2}{*}{\textbf{Currency Pairs}} &  \multicolumn{8}{c}{\textbf{Metrics}}\\\cline{3-10} % <-- Combining 2 rows with arbitrary with (*) and content 12
   
      &  & Balance & Net Profit & Total Trades & Profit Factor & Expected Payoff & Drawdown in \% & Recovery Factor & Sharpe Ratio\\ % <-- Content of first column omitted.
      \hline
